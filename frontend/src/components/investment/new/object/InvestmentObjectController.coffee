class InvestmentObject extends Controller
  constructor: (InvestmentService,ListApi, ListTransformerService) ->
    ...
    @reset = ->
      objectTypeTemplates = {}
      objectTypeTemplates['Здание'] = '/components/investment/new/object/building.html'
      objectTypeTemplates['Земельный участок'] = '/components/investment/new/object/parcel.html'
