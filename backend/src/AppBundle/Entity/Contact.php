 ...
 * Contact
 *
 * @ORM\Table(name="CONTACT", uniqueConstraints={@ORM\UniqueConstraint(name="KF_SR_CONTACTIDinclACCOUNTID", columns={"CONTACTID", "ACCOUNTID", "LASTNAME", "FIRSTNAME", "MIDDLENAME", "PREFIX", "SUFFIX", "ADDRESSID", "SHIPPINGID", "WORKPHONE", "HOMEPHONE", "FAX", "MOBILE", "PAGER", "PAGERNUMERIC", "EMAIL", "SECONDARYEMAIL", "TITLE", "BIRTHDAY", "SECCODEID", "STATUS", "LASTNAME_UC", "DONOTSOLICIT", "EMAIL3", "OTHERPHONE", "LASTHISTORYDATE", "LASTHISTORYBY", "SALUTATION"})}})
 * @ORM\Entity
 */
class Contact
{
