...
class SpkOffice
{
     ...
     * Set leadingBroker
     *
     * @param string $leadingBroker
     * @return SpkOffice
     */
    public function setLeadingBroker($leadingBroker)
    {
        $this->leadingBroker = $leadingBroker;
     ...
     * @return string 
     */
    public function getLeadingBroker()
    {
        return $this->leadingBroker;
    }
